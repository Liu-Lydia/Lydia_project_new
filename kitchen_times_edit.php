...
$title = '私廚料理場次修改';
$pageName = 'kitchen_times_edit';

if (!isset($_GET['sid'])) {
    header('Location: kitchen_times.php');
    exit;
}
...
$row = $pdo
    ->query("SELECT * FROM kitchen_times WHERE sid=$sid")
    ->fetch();
        ...
        <div class="col-lg-6">
            ...
            <div class="card mt-4">
                <div class="card-body pt-0 pb-0">
                    <h5 class="card-title text-center pt-4">編輯私廚料理場次</h5>
...
<script>
    ...
    function CheckForm() {
        ...
        if (isPass) {
            ...
            fetch('kitchen_times_edit_api.php', {
                    method: 'POST',
                    body: fd
                })
                .then(r => r.json())
